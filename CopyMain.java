package assignment_8a;  //This java file is inside package named package1 inside src folder.
...
public class CopyMain     //Class declaration containing main function.
{
	public static void main(String[] args) throws Exception  //main function declaration. and because it is static, program execution starts from main function. 
	{
		...
		FileInputStream readSrcFile = new FileInputStream("C:/Users/Aschita/Desktop/SrcFile.txt");
		
		//We will create the object of FileOutputStream and will pass the object of File containig filePath to its constructors.
		FileOutputStream writeSrcFile = new FileOutputStream("C:/Users/Aschita/Desktop/DestnFile.txt");
		...
		BufferedReader readDestnFile = new BufferedReader(new FileReader("C:/Users/Ashutosh/Desktop/AcadGild/Core Java/CH8/destnFile.txt"));
